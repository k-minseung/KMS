...
public class Ex01_Equals {
	public static void main(String[] args) {
		//equals() 
		//기본 자료형의 데이터들을 등등 비교를 위해서 '==' 비교연산자를 사용한다
		//하지만 객체를 동등비교 할 경우 , 해당 객체릐 값을 비교하는 것이 아니라
		...
		//암시적 객체 생성을 할 떄, 먼저 만들어져 있는게 있으면 같이 참조를 한다.
		System.out.println("str1 vs str2 : "+ (str1 == str2 ));
		
		//str1 = "Bye"; // str2와 같은 주소를 참조하니까 str2 Bye로 바뀌는게 맞지않나?
		System.out.println("str2 : "+str2);
		
		
		//불변의 법칙
		
		//값이 새로 대입되거나 추가가 된다면 기존의 메모리를 버리고 새로 할당받는다.
		
		System.out.println("str3 vs str2 : "+ (str3 == str2 ));
