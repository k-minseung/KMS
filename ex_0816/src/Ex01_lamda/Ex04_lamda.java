...
public class Ex04_lamda {
	public static void main(String[] args) {
		...
		c1.accept("홍길동");
		BiConsumer<String, Integer> c2 = (x,y) -> System.out.println("입력 값1 : "+x+" 입력 값2 : "+y);
		c2.accept("제임스", 100);
		...
		else System.out.println("두 문자열의 값은 다릅니다.");
	
		Predicate<Integer> p1 = t -> t >=60;
		int score = 65;
		boolean pass = p1.test(65);
		if(pass) {
			System.out.println("홍길동님의 점수 : "+ score + "점 합격입니다.");
		}else {
			System.out.println("홍길동님의 점수 : "+ score + "점 불합격입니다.");
		}
