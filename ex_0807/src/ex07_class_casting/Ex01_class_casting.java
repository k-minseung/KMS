...
public class Ex01_class_casting {
	public static void main(String[] args) {
		...
		// 객체끼리 비교를 할 땐 ==연산자는 주소값이 같은지 비교한다.
		if( p3 == c1 /* 객체끼리의 비교여서 주소값이 같은지 비교한다 */) {
			System.out.println("p3와 c1은 같은 객체를 참조하고 있습니다.");
			
		}
		
		//타입을 변환한다고 객체가 바뀌는 것이 아니라, 객체는 보존되고 사용만 부모 객체처럼한다.
		//자동타입변환은 반드시 자식클래스의 객체를 부모타입으로 변환할때만 적용할 수 있다.
