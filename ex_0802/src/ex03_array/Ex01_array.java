...
public class Ex01_array {
	...
	public static void main(String[] args) {
		...
		//배열명을 출력하며 배열이 갖고 있는 주소값을 출력한다.
		//뱐수가 갖고 있는 값을 출력하는 것과 같은 원리이다.
		...
		//배열의 구조
		//1. 인덱스 (index) - 집의 호수
		//배열을 만든 후에는 값을 넣거나 꺼내야한다.
		//배열은 각 공간마다 위치를 알려주는 위치값이 존재한다.
		//우리는 배열이 지니는 값들의 위치값을 인덱스(index)라고 부른다.
		//인덱스는 배열의 공간마다 붙여진 번호로 0부터 시작하여 순차적을 증가한다.
